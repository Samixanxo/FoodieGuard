...
class search_Fragment : Fragment(R.layout.fragment_home_fragment), SearchView.OnQueryTextListener {
    ...
    private suspend fun restaurants(phone: String): List<Restaurant> {
        return suspendCoroutine { continuation ->
            var call = service.getRestaurant()
            if (!phone.isEmpty()) {
                call = service.getRestaurantByPhone(phone)
            }
